...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="../../DriversRegistration" method="post">
        <p>Add new Driver</p>
        <div class="item">
          <label for="name">Select Your Image Only Download folder<span>*</span></label>
          <input id="name" type="file" name="img" required>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <input id="phone" type="text" name="no" required>
        </div>
        <div class="item">
          <label for="bdate">Date of Birth<span>*</span></label>
          <input id="bdate" type="date" name="dob" required>
        ...
        <div class="question">
          ...
          <div class="question-answer">
            <div>
              <input type="radio" value="Male" id="radio_1" name="gen"/>
              <label for="radio_1" class="radio"><span>Male</span></label>
            </div>
            <div>
              <input  type="radio" value="Female" id="radio_2" name="gen"/>
        ...
        <div class="btn-block">
          <button type="button" name="" onclick="history.back()">BACK</button>
